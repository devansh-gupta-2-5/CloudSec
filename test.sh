...
echo -e "\n[2/3] Testing Rate Limiting (DoS Mitigation)..."
...
echo -e "\n[3/3] Testing Privilege Escalation (No Token)..."
...
echo -e "\n[4/5] Testing SQL Injection Mitigation..."
...
# 5. SEQUENTIAL BRUTE FORCE (MONITOR TEST)
echo -e "\n[5/5] Testing Application-Level IP Banning..."
